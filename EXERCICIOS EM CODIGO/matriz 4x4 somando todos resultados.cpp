...
int main(void)
{
int m[4][4], l, c;//definindo uma matriz de 3,3 e criando uma variavel L pra linha e C pra coluna

//(PRIMEIRA PARTE PARA LER AS COISAS

   for(l=0; l<4; l++){//fizemos um for para ler os numeros das linhas de 0 a 2(total 3)
    for(c=0; c<4; c++){//fizemos um for pra ler os numeros das colunas de 0 a 2(total 3)
...
//(SEGUNDA PARTE PARA ESCREVER OS RESULTADOS E ORDEM DOS RESULTADOS
    ...
    for(l=0; l<4; l++){//fizemos um for pra escrever as linhas da matriz
     for(c=0; c<4; c++){//fizemos um for pra escrever as colunas da matriz
